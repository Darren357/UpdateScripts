'example: cscript replacescript.vbs html.txt "old string" "new string" >> newfile.txt
'I had to use this instead of a .bat file because mt string has special chars.
